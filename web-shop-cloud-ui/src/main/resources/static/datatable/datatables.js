 ...
 *   https://datatables.net/download/#bs4/dt-1.10.22/b-1.6.5/fh-3.1.7/kt-2.5.3/sb-1.0.0
 *
 * Included libraries:
 *   DataTables 1.10.22, Buttons 1.6.5, FixedHeader 3.1.7, KeyTable 2.5.3, SearchBuilder 1.0.0
 */
...
(function ($, window, document, undefined) {
    ...
    DataTable.ext = _ext = {
         ...
         *  @type string
         */
        build: "bs4/dt-1.10.22/b-1.6.5/fh-3.1.7/kt-2.5.3/sb-1.0.0",
...
(function () {
    ...
    var SearchBuilder = /** @class */ (function () {
        ...
        SearchBuilder.prototype._updateTitle = function (count) {
            $$2(this.dom.title).text(this.s.dt.i18n('searchBuilder.title', {
            ...
            init: function (dt, node, config) {
                var sb = new $.fn.dataTable.SearchBuilder(dt, $.extend({
                    filterChanged: function (count) {
                        dt.button(node).text(dt.i18n('searchBuilder.button', {
                            0: 'Search Builder',
                            _: 'Search Builder (%d)'
                        }, count));
                    }
